...
/*
Problem Statement:A group of students are sitting in a circle. The teacher is electing a new class president.
...
Starting at the student next to the one that was just removed, the teacher resumes singing and walking around
 the circle.after the teacher is done singing, the next student is removed.
 ...
 A song of length k will result in the teacher walking past k students on each round.
  ...
  Signature:public static int whoIsElected(int n, int k) {}
